...
import spring.boot.rest.sample.enums.TokenStoreType;
...
public class CustomTokenStore {
	...
	private final static String defaultType = "DB";

	@Autowired
	public CustomTokenStore(RedisConnectionFactory redisConnectionFactory, Environment environment,
